...
public class Circuit
{
    ...
    public void Render()
    {
        ...
        var thirdPoint = getNextLinePoint(nextPoint, new Point(0, 1), lineRenderer);
    ...
    private Point getNextLinePoint(Point currentPoint, Point direction, LineRenderer line)
    {
